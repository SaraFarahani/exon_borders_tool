...
#USER: write your <filename>.txt containing gene families here.
my $filename = '';

#USER: name each families with family stable ids as strings in the array below.
my @family_stable_ids=("");
my $num_fam_stid=@family_stable_ids;

#USER: write a description to every family as strings in the array below. 
